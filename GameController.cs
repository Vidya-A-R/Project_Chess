...
public class GameController
{
    ...
    public Type type;
    public delegate void PlayerStatusChangedHandler(IPlayer player, PlayerStatus newStatus);
    ...
    public GameController(Board board)
    {
        ...
        InitializeInitialPieces();
        
    }
    private void InitializeInitialPieces()
    {
    ...
    public void AddPlayer(string name, int playerIndex)
    {
    ...
    public Color SetPlayerColor(IPlayer player, int playerIndex)
    {
